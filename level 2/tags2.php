    ...
    ?>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $tags = $lesInformations->fetch_assoc();
            ...
            <aside>
                ...
                <section>
                    ...
                    <p>Sur cette page vous trouverez les derniers messages comportant
                        le mot-clé
                    <a href="http://localhost/pages/tags.php?tag_id=<?php echo intval($tagId) ?>"><?php echo $tag['label'] ?></a>
                    </p>
            ...
            <main>
                ...
                while ($post = $lesInformations->fetch_assoc())
                {
                    ...
                    <address><a href="http://localhost/pages/wall.php?user_id=<?php echo $post["user_id"]?>"><?php echo $post["author_name"]?></address>
                    <div>
