        ...
        <div id="wrapper">          
            <aside>
                ...
                <section>
                    ...
                    <p>Sur cette page vous trouverez la liste des personnes qui
                        ...
                        n° <a href="http://localhost/pages/wall.php?user_id=<?php echo intval($userId)?>"><?php echo $userId ?></a></p>
            ...
            <main class='contacts'>
                ...
                <article>
                    ...
                    <h3><a href="http://localhost/pages/wall.php?user_id=<?php echo $user["id"]?>">
                            <?php echo $user["alias"]?>
                        </a></h3>
                    <p><a href="http://localhost/pages/wall.php?user_id=<?php echo $user["id"]?>"><?php echo $user["id"]?></a></p>
                </article>
                <?php } ?>
            </main>
        </div>
